...
var getJSONP = function (sourceUrl, params) {
    ...
    var urlCat = function (params) {
        for (const param in params) {
            ...
            if (param == 'callback') url += `${param}=${element}`;else url += `${param}=${element}&`;
        }
    };
...
var parse = function (smid) {
     ...
     */
    let getMusic = (() => {
        var _ref = _asyncToGenerator(function* (smid) {
            ...
            let info = yield getJSONP(url.url, url.params);
